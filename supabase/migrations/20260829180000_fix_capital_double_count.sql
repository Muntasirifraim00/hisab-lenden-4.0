-- =====================================================================
-- পুঁজি প্রতি চালানে দুবার হিসাব হচ্ছিল — সেটা ঠিক করা
-- =====================================================================
-- দুটো ব্যবস্থা একসাথে চলছিল:
--
--   ১. hb_create_invoice শেষে হাতে ডাকত
--      hb_update_capital_after_transaction(), আর
--   ২. invoices টেবিলের উপর hb_capital_update ট্রিগার (AFTER INSERT OR
--      UPDATE) paid_amount দেখে একই কাজ করত।
--
-- ফলে প্রতিটি চালানে টাকাটা দুবার যোগ বা বিয়োগ হতো। পরীক্ষা করে দেখা
-- গেছে: ১০০০০০ পুঁজিতে ৫০০ টাকার একটা বিক্রয়ের পর পুঁজি দাঁড়াত
-- ১০১০০০ — হওয়ার কথা ১০০৫০০।
--
-- ট্রিগারটাই রাখা হলো, কারণ সেটা কিস্তি যোগ হলেও (hb_add_payment,
-- hb_add_advance_payment — দুটোই paid_amount বাড়ায়) নিজে থেকে ধরতে
-- পারে। hb_create_invoice থেকে হাতে-ডাকা লাইনটা বাদ।
--
-- hb_update_capital_after_transaction ফাংশনটা রেখে দেওয়া হলো, তবে
-- এখন আর কেউ ডাকে না — কারো EXECUTE অনুমতিও নেই।
-- =====================================================================
...
BEGIN
  ...
  -- পুঁজি এখানে ছোঁয়া হয় না। invoices-এর উপর hb_capital_update ট্রিগারটাই
  -- paid_amount দেখে পুঁজি সরায় — আগে এখানেও একবার ডাকা হতো, ফলে প্রতি
  -- চালানে টাকাটা দুবার যোগ/বিয়োগ হতো (১০০০০০ পুঁজিতে ৫০০ টাকার বিক্রয়ের
  -- পর দাঁড়াত ১০১০০০, হওয়ার কথা ১০০৫০০)। ট্রিগার রাখা হলো কারণ কিস্তি
  -- যোগ হলেও (hb_add_payment) সেটা নিজে থেকেই ধরতে পারে।
